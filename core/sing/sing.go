...
func New(c *conf.CoreConfig) (vCore.Core, error) {
	...
	// Add sniff route rule for sing-box 1.13.0+
	// Sniff configuration has moved from inbound fields to route rule actions
	sniffRule := option.Rule{
		Type: "default",
	...
	// Prepend sniff rule to ensure it runs first
	options.Route.Rules = append([]option.Rule{sniffRule}, options.Route.Rules...)
